        ...
        {isOpen && (
          ...
          >
            ...
            <div className="p-4 bg-white text-gray-800 flex flex-col space-y-3">
              <a href="tel:1300123456" className="flex items-center text-sm hover:text-[#0056a8] transition-colors">
                <PhoneCall className="h-4 w-4 mr-2 text-[#0056a8]" aria-hidden="true" />
              ...
              >
                <Mail className="h-4 w-4 mr-2 text-[#0056a8]" aria-hidden="true" />
                <span>info@proficientlegal.com.au</span>
              </a>
              <div className="flex items-center text-sm">
                <MapPin className="h-4 w-4 mr-2 text-[#0056a8]" aria-hidden="true" />
                <span>Sydney, Melbourne, Brisbane</span>
              </div>
              <div className="flex items-center text-sm">
                <Clock className="h-4 w-4 mr-2 text-[#0056a8]" aria-hidden="true" />
