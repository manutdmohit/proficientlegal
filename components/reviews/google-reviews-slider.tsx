...
export function GoogleReviewsSlider() {
  ...
  const visibleReviews = reviewsData.reviews.slice(
    currentIndex,
      ...
      <div className="container mx-auto px-2 sm:px-6">
        <AnimationWrapper>
          <div className="text-center mb-8">
            <p className="text-gray-600 max-w-3xl mx-auto">
              Read authentic reviews from our clients about their experience
            ...
            <div
              ...
              style={{
                ...
                width:
                  visibleCount === 1
                    ? '100%'
                    : `${(reviewsData.reviews.length / visibleCount) * 100}%`,
                gap: '1rem',
              }}
            >
              {reviewsData.reviews.map((review) => (
                <div
                  ...
                  className={
                    visibleCount === 1
                      ? 'box-border flex-none w-full min-w-0 max-w-full flex flex-col'
                      : 'box-border basis-0 flex-1 min-w-0 w-full max-w-full flex flex-col'
                  }
                  style={{
                    width:
                      visibleCount === 1 ? '100%' : `${100 / visibleCount}%`,
                    padding: '0 0.5rem',
                  }}
                >
        ...
        {needsNavigation && (
          <div className="flex justify-center mt-4 sm:mt-6 md:mt-8 space-x-1 sm:space-x-2">
            {Array.from({
              length: reviewsData.reviews.length - visibleCount + 1,
            }).map((_, index) => (
              <button
                key={index}
