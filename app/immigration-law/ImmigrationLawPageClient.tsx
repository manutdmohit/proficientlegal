      ...
      <main>
          ...
          <div className="container absolute inset-0 flex items-center z-20">
            <div className="max-w-3xl text-white drop-shadow-lg">
              ...
              <p className="text-xl mb-8 text-white/90 leading-relaxed text-shadow subtitle">
                Expert guidance through Australia's complex immigration system. We help individuals and families
                navigate visa applications and immigration processes with confidence.
              </p>
              ...
              <AnimationWrapper animation="slideRight">
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    Proficient Legal specializes in efficiently resolving complex immigration matters in Australia. Our
                    experienced team provides expert guidance through every step of the immigration process, from visa
                    applications to appeals and citizenship.
                  </p>
                  <p className="text-gray-600 mb-4">
                    We understand that immigration matters are often life-changing decisions. That's why we take a
                    personalized approach to each case, ensuring that your unique circumstances and goals are carefully
                    considered in developing the most effective strategy.
                  </p>
                  <p className="text-gray-600 mb-6">
                    Whether you're seeking to join family, pursue work opportunities, or establish a new life in
                    Australia, our team has the expertise to help you navigate the complexities of immigration law with
                    confidence.
                  </p>
          ...
          <div className="container">
            <AnimationWrapper animation="slideUp">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-[#003b73] mb-4 tracking-slight">Visa Services</h2>
                <p className="text-gray-600 max-w-3xl mx-auto">
                  Comprehensive visa application assistance tailored to your specific needs.
                </p>
              </div>
            </AnimationWrapper>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <AnimationWrapper animation="slideUp" delay={0.1}>
                <Card className="h-full shadow-lg hover:shadow-xl transition-shadow overflow-hidden flex flex-col">
                  ...
                  <CardContent className="flex-grow">
                    <p className="text-gray-600 mb-4">
                      Expert assistance with intricate partner visa applications, helping couples navigate the complex
              ...
              <AnimationWrapper animation="slideUp" delay={0.2}>
                <Card className="h-full shadow-lg hover:shadow-xl transition-shadow overflow-hidden flex flex-col">
                  ...
                  <CardContent className="flex-grow">
                    <p className="text-gray-600 mb-4">
                      Support for Onshore Protection Visa Subclass 866, particularly for international students and
                      tourists fearing return to their home country.
                    </p>
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-[#0056a8] mr-2 flex-shrink-0 mt-0.5" />
              ...
              <AnimationWrapper animation="slideUp" delay={0.3}>
                <Card className="h-full shadow-lg hover:shadow-xl transition-shadow overflow-hidden flex flex-col">
                  ...
                  <CardContent className="flex-grow">
                    <p className="text-gray-600 mb-4">
                      Guidance on temporary and permanent work visas, helping skilled professionals and employers
                      navigate Australia's work visa programs.
                    </p>
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-[#0056a8] mr-2 flex-shrink-0 mt-0.5" />
              ...
              <AnimationWrapper animation="slideUp" delay={0.4}>
                <Card className="h-full shadow-lg hover:shadow-xl transition-shadow overflow-hidden flex flex-col">
                  ...
                  <CardContent className="flex-grow">
                    <p className="text-gray-600 mb-4">
                      Assistance with business innovation, investment, and employer-sponsored visas for entrepreneurs
                      and business owners.
                    </p>
                    <ul className="space-y-2">
                      <li className="flex items-start">
              ...
              <AnimationWrapper animation="slideUp" delay={0.5}>
                <Card className="h-full shadow-lg hover:shadow-xl transition-shadow overflow-hidden flex flex-col">
                  ...
                  <CardContent className="flex-grow">
                    <p className="text-gray-600 mb-4">
                      Support for skilled migration visa applications, helping qualified professionals secure permanent
              ...
              <AnimationWrapper animation="slideUp" delay={0.6}>
                <Card className="h-full shadow-lg hover:shadow-xl transition-shadow overflow-hidden flex flex-col">
                  ...
                  <CardHeader className="pb-2">
                    ...
                    <CardTitle className="text-xl">Visitor, Student & Retirement Visas</CardTitle>
                  </CardHeader>
                  <CardContent className="flex-grow">
                    <p className="text-gray-600 mb-4">
                      Help with various temporary visa applications for visitors, students, and retirees looking to
              ...
              <AnimationWrapper animation="slideUp" delay={0.7}>
                <Card className="h-full shadow-lg hover:shadow-xl transition-shadow overflow-hidden flex flex-col">
                  ...
                  <CardHeader className="pb-2">
                    ...
                    <CardTitle className="text-xl">Family Migration Visas</CardTitle>
                  </CardHeader>
                  <CardContent className="flex-grow">
                    <p className="text-gray-600 mb-4">
                      Including partner, children, and parent visas to help families reunite and settle in Australia.
                    </p>
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-[#0056a8] mr-2 flex-shrink-0 mt-0.5" />
              ...
              <AnimationWrapper animation="slideUp" delay={0.8}>
                <Card className="h-full shadow-lg hover:shadow-xl transition-shadow overflow-hidden flex flex-col">
                  ...
                  <CardHeader className="pb-2">
                    ...
                    <CardTitle className="text-xl">Resident Return Visas</CardTitle>
                  </CardHeader>
                  <CardContent className="flex-grow">
                    <p className="text-gray-600 mb-4">
                      Assistance for returning residents who need to renew their travel facilities after spending time
                      outside Australia.
                    </p>
                    <ul className="space-y-2">
                      <li className="flex items-start">
        ...
        <section id="immigration-services" className="py-16 bg-white">
          <div className="container">
            <AnimationWrapper animation="slideUp">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-[#003b73] mb-4 tracking-slight">Immigration Services</h2>
                <p className="text-gray-600 max-w-3xl mx-auto">
              ...
              <AnimationWrapper animation="slideUp" delay={0.1}>
                <Card className="h-full shadow-lg hover:shadow-xl transition-shadow overflow-hidden flex flex-col">
                  ...
                  <CardHeader className="pb-2">
                    ...
                    <CardTitle className="text-xl">Initial Review and Advice</CardTitle>
                  </CardHeader>
                  <CardContent className="flex-grow">
                    <p className="text-gray-600 mb-4">
                      Comprehensive assessment of individual circumstances to determine the most suitable visa options
              ...
              <AnimationWrapper animation="slideUp" delay={0.2}>
                <Card className="h-full shadow-lg hover:shadow-xl transition-shadow overflow-hidden flex flex-col">
                  ...
                  <CardHeader className="pb-2">
                    ...
                    <CardTitle className="text-xl">Counsel on Strategies</CardTitle>
                  </CardHeader>
                  <CardContent className="flex-grow">
                    <p className="text-gray-600 mb-4">
                      Tailored migration strategies to suit specific needs, taking into account your unique
              ...
              <AnimationWrapper animation="slideUp" delay={0.3}>
                <Card className="h-full shadow-lg hover:shadow-xl transition-shadow overflow-hidden flex flex-col">
                  ...
                  <CardHeader className="pb-2">
                    ...
                    <CardTitle className="text-xl">Corporate Migration</CardTitle>
                  </CardHeader>
                  <CardContent className="flex-grow">
                    <p className="text-gray-600 mb-4">
                      Services for businesses seeking to sponsor employees, including guidance on employer obligations
              ...
              <AnimationWrapper animation="slideUp" delay={0.4}>
                <Card className="h-full shadow-lg hover:shadow-xl transition-shadow overflow-hidden flex flex-col">
                  ...
                  <CardHeader className="pb-2">
                    ...
                    <CardTitle className="text-xl">Individual Migration</CardTitle>
                  </CardHeader>
                  <CardContent className="flex-grow">
                    <p className="text-gray-600 mb-4">
                      Personalized assistance for individual applicants, providing support throughout the entire
                      migration process.
                    </p>
                    <ul className="space-y-2">
                      <li className="flex items-start">
              ...
              <AnimationWrapper animation="slideUp" delay={0.5}>
                <Card className="h-full shadow-lg hover:shadow-xl transition-shadow overflow-hidden flex flex-col">
                  ...
                  <CardHeader className="pb-2">
                    ...
                    <CardTitle className="text-xl">Australian Citizenship Applications</CardTitle>
                  </CardHeader>
                  <CardContent className="flex-grow">
                    <p className="text-gray-600 mb-4">
                      Guidance through the citizenship process, helping permanent residents become Australian citizens.
                    </p>
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-[#0056a8] mr-2 flex-shrink-0 mt-0.5" />
              ...
              <AnimationWrapper animation="slideUp" delay={0.6}>
                <Card className="h-full shadow-lg hover:shadow-xl transition-shadow overflow-hidden flex flex-col">
                  ...
                  <CardHeader className="pb-2">
                    ...
                    <CardTitle className="text-xl">Appeals & Ministerial Intervention</CardTitle>
                  </CardHeader>
                  <CardContent className="flex-grow">
                    <p className="text-gray-600 mb-4">
                      Representation in the Administrative Appeals Tribunal (AAT) and assistance with requests for
                      ministerial intervention in exceptional cases.
                    </p>
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-[#0056a8] mr-2 flex-shrink-0 mt-0.5" />
        ...
        <section id="immigration-process" className="py-16 bg-gray-50">
          <div className="container">
            <AnimationWrapper animation="slideUp">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-[#003b73] mb-4 tracking-slight">Our Immigration Process</h2>
                <p className="text-gray-600 max-w-3xl mx-auto">
                  We guide you through every step of your immigration journey with expertise and clarity.
                </p>
              </div>
            </AnimationWrapper>
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          We assess your circumstances, discuss your goals, and identify potential visa options and
                  ...
                  <div className="bg-white p-6 rounded-lg border border-gray-200">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h3 className="text-xl font-semibold text-[#003b73] mb-2">Strategy Development</h3>
                        <p className="text-gray-600">
                          We create a tailored immigration strategy based on your specific circumstances, goals, and
                          eligibility factors.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="bg-white p-6 rounded-lg border border-gray-200">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h3 className="text-xl font-semibold text-[#003b73] mb-2">Documentation Preparation</h3>
                        <p className="text-gray-600">
                          We guide you through gathering and preparing all necessary documentation, ensuring everything
                  ...
                  <div className="bg-white p-6 rounded-lg border border-gray-200">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h3 className="text-xl font-semibold text-[#003b73] mb-2">Application Lodgment</h3>
                        <p className="text-gray-600">
                          We prepare and submit your application, ensuring all forms are correctly completed and all
                  ...
                  <div className="bg-white p-6 rounded-lg border border-gray-200">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h3 className="text-xl font-semibold text-[#003b73] mb-2">Application Management</h3>
                        <p className="text-gray-600">
                          We manage all communication with the Department, respond to requests for additional
                          information, and keep you updated throughout the process.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-lg border border-gray-200">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h3 className="text-xl font-semibold text-[#003b73] mb-2">Visa Grant & Follow-up</h3>
                        <p className="text-gray-600">
                          We assist with any post-grant requirements and provide guidance on your rights and obligations
                          as a visa holder or new resident.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="container">
            <div className="bg-[#0056a8] rounded-xl p-8 md:p-12 shadow-lg text-white">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div>
                  <h2 className="text-3xl font-bold mb-4 tracking-slight">Ready to Discuss Your Immigration Matter?</h2>
                  <p className="mb-6 text-white/90">
                    Our team of experienced immigration lawyers are here to help. Contact us today for a confidential
                    consultation and take the first step toward your Australian immigration journey.
                  </p>
          ...
          <div className="container">
            <AnimationWrapper animation="slideUp">
              <div className="text-center mb-12">
                ...
                <p className="text-gray-600 max-w-3xl mx-auto">
                  Find answers to common questions about immigration law and our services.
                </p>
              </div>
            </AnimationWrapper>
              ...
              <div className="space-y-4">
                <FaqAccordion
                  items={[
                    ...
                    {
                      question: "Can I apply for a visa if I have been refused before?",
                      answer:
